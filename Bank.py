...
class Bank:
                ...
                if input("Access Key : ") == "123login":
                    while True:
                        ...
                        if opt == "1":
                            ...
                            for i in list(self.Account_Database.keys()):
                                print(i)
                            print()
                            username = input("Enter the username : ")
                            if username in self.Account_Database:
                                print("1. Customer Details")
                                if eval(input("Option : ")) == 1:
    ...
    def CurrencyConvertor(self):
        ...
        while True:
            try:
                while True:
                    try:
                        curinput = eval(input("Input Currency Type : ")) - 1
                        curoutput = eval(input("Output Currency Type : ")) - 1
                        break
                    except:
                        print("Enter the index number of the Currency")
                print("Enter the Amount you want to convert")
                print(self.CurrenciesList[curinput][1], end=' ')
                val = eval(input(" : "))
                try:
    ...
    def StockMarketExchange(self):
        ...
        if True_False(input("Do you want Save the Information in a file [Y/N]    : "), 1):
...
class Customer(Bank):
    ...
    def GetData(self):
        while True:
            ...
            try:
                ...
                self.LastName  = input("Enter your Last Name                 : ").upper()
                self.Name      = self.FirstName + " " + self.LastName
                self.Email     = input("Enter your Email Address             : ")
                self.DOB       = input("Enter Date of Birth [DD/MM/YYYY]     : ").split("/")
                self.Phone1    = input("Enter Phone Number(+CountryCode_No)  : ")
                self.altPhone  = input("Enter Alternative Phone Number       : ")
                self.Sex       = input("Male/Female                          : ").upper()
                print()
                if input("Continue with this info [Y/N]     : ").lower() == "n":
                    self.__init__()
                    continue
                print()
                system("cls")
                print("Services")
                self.Services  = {"ATM" : True_False(input("Do you want ATM services [Y/N]    : "), 1),
                                "NetBank" : True_False(input("Do you want Net Banking [Y/N]     : "),1),
                                "MobileBank" : True_False(input("Do you want Mobile Banking [Y/N]  : "), 1),
                                "ChequeBk" : True_False(input("Do you want Cheque Book [Y/N]     : "), 1)}
                self.Loan      = {"Car" : False,
                                "Home" : False,
                                "Gold" : False,
                                "Education" : False}
                ...
                system("cls")
                print("More Info")
                self.PAN_no    = input("Enter PAN Card No                    : ")
                self.Passport  = input("Enter Passport No                    : ")
                system("cls")
                print()
                print(" Diamond >= 1,00,00,000\n Platinum >= 10,00,000\n Gold >= 1,00,000\n Silver >= 0")
                print()
                self.Balance   = eval(input("Enter the Amount for Initial Deposit : "))
        ...
        while i>0:
            ...
            if password == self.password:
                ...
                if opt == "1":
                    ...
                    system("cls")
                    self.Phone1    = input("Enter your Phone Number              : ")
                    self.Activity += [["Phone Number Updated on {}".format(str(ctime()))]]
                elif opt == "3":
                    system("cls")
                    self.altPhone  = input("Enter your Alternative Phone Number  : ")
                    ...
                    while True:
                        ...
                        ch = input("Do you want to Continue with this Account Number [y/n] : ").upper()
                        if ch == "Y":
                            print("Assigning your Account Number")
                            bar = ProgressBar()
                            for i in bar(list(range(100))):
                                sleep(0.02)
        ...
        for i in range(3):
            ...
            while i > 0:
                try:
                    ...
                    email = input("Please Enter Your Email Address One More Time  : ")
                    self.Email = email
                    i -= 1
            if i > 0:
                check_verify = eval(input("Enter the Verification Code : "))
    ...
    def verify_Phone(self):
        try:
            ...
            system("cls")
            try:
                Phone_1 = input("Enter Country Code : ")
                Phone_2 = input("Enter Phone Number : ")
                ...
                for i in range(2):
                    try:
                        ...
                        self.Phone1 = "+" + Phone_1 + Phone_2
                        print("Phone Number : ", self.Phone1)
                        if True_False(input("Confirm Number (Y/N)  : "), 0):
                            client.api.account.messages.create(
                                to = self.Phone1,
                                from_ = "+19177257450",
                                body = msg
        ...
        if user:
            ...
            if password == user.password:
                ...
                while True:
                    ...
                    print("5. Logout")
                    print()
                    opt = eval(input("Enter an option            : "))
                    print()
                    if opt == 1:
                        system("cls")
...
def DisplayData(a_username):
    ...
    j = 0
    for i in list(user.Services.keys()):
        list_services[j][0] = i
        list_services[j][1] = True_False(user.Services[i], 2)
        j += 1
    j = 0
    for i in list(user.Loan.keys()):
        list_loan[j][0] = i
...
def FundsTransfer(a_username):
    ...
    Account_Name = input("Enter the Name of the Account Holder of the Account you wish to transfer to : ")
    ...
    if user2:
        while True:
            ...
            if PasswordVerification == user1.password:
                Amount = eval(input("Enter the Amount you wish to transfer                                       : INR "))
